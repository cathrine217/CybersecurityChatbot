    ...
    public partial class MainWindow : Form
    {
        ...
        private void SetupUI()
        {
            ...
            messageInput = new TextBox
            {
                ...
                Size = new Size(this.ClientSize.Width - 190, 34),
                BackColor = Color.FromArgb(40, 50, 60),
                ForeColor = Color.White,
            ...
            {
                Text = "Send",
                Location = new Point(this.ClientSize.Width - 170, 8),
                Size = new Size(75, 34),
                BackColor = Color.FromArgb(0, 120, 215),
                ForeColor = Color.White,
                FlatStyle = FlatStyle.Flat,
            ...
            {
                Text = "Clear",
                Location = new Point(this.ClientSize.Width - 90, 8),
                Size = new Size(75, 34),
        ...
        private string GetHelpMessage()
        {
            return "AVAILABLE COMMANDS\n\n" +
                   ...
                   "OTHER COMMANDS\n" +
                   "  - Help - Show this menu\n" +
                   "  - Set Your Name - Personalize the bot\n\n" +
                   "Try typing: Tell me about passwords";
        }
